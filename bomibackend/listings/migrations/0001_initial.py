    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('For Lease', 'For Lease')], default='For Sale', max_length=50)),
                ('price', models.IntegerField()),
                ('bedrooms', models.IntegerField()),
                ('bathrooms', models.DecimalField(decimal_places=1, max_digits=2)),
                ('home_type', models.CharField(choices=[('Duplex', 'Duplex'), ('Flat', 'Flat'), ('Shop', 'Shop'), ('Office', 'Office')], default='Flat', max_length=50)),
                ...
                ('propertyOwner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='propertyowners.PropertyOWner')),
            ],
        ),
    ]
