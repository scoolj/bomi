...
from propertyowners.models import PropertyOwner
...
class Listing(models.Model):
    ...
    propertyOwner = models.ForeignKey(
        PropertyOwner, on_delete=models.DO_NOTHING)
    ...
    home_type = models.CharField(
        max_length=50, choices=HomeType.choices, default=HomeType.FLAT)
